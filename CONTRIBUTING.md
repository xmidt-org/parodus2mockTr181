...
application, document it in the [README](https://github.com/Comcast/mockCcsp/blob/master/README.md) or [wiki](https://github.com/Comcast/mockCcsp/wiki)! This includes new features, additional variants of behavior and breaking changes.
